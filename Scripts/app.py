...
# Hardware Specifications in Two Columns
st.header("Step 2: Hardware Specifications")
...
# Storage Specifications in Two Columns
st.header("Step 3: Storage Specifications")
...
st.header("Step 4: Software Specifications")
